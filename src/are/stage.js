...
ARE.Stage = ARE.Container.extend({
    ...
    "scalable": function(scaleX, scaleY) {
        ...
        domSurface.style.transform = domSurface.style.msTransform = domSurface.style.OTransform = domSurface.style.MozTransform = domSurface.style.webkitTransform = "scale(" +  this._scaleX  + "," + this._scaleY  + ")";
        this.offset = this._getXY(this.canvas);
    },
