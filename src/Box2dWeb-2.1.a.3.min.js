...
/*
* Convex Separator for Box2dWeb
*
* This class has been written by Antoan Angelov and transplanted into Javascript by Yorhom (Yorhom Wang). 
...
if (!Box2D.Box2DSeparator) {
    Box2D.Box2DSeparator = {};
}
...
(function () {
    ...
    b2Separator.prototype.Separate = function (body, fixtureDef, verticesVec, scale) {
        if (!scale) {
            scale = 30;
        }
    ...
    b2Separator.prototype.Validate = function (verticesVec) {
    ...
    b2Separator.prototype.calcShapes = function (verticesVec) {
        var vec;
        var i, n, j;
    ...
    b2Separator.prototype.hitRay = function (x1, y1, x2, y2, x3, y3, x4, y4) {
    ...
    b2Separator.prototype.hitSegment = function (x1, y1, x2, y2, x3, y3, x4, y4) {
        var t1 = x3 - x1, t2 = y3 - y1, t3 = x2 - x1, t4 = y2 - y1,
			t5 = x4 - x3, t6 = y4 - y3, t7 = t4 * t5 - t3 * t6, a;
    ...
    b2Separator.prototype.isOnSegment = function (px, py, x1, y1, x2, y2) {
    ...
    b2Separator.prototype.pointsMatch = function (x1, y1, x2, y2) {
        var dx = (x2 >= x1 ? x2 - x1 : x1 - x2), dy = (y2 >= y1 ? y2 - y1 : y1 - y2);
        return (dx < 0.1 && dy < 0.1);
    };

    b2Separator.prototype.isOnLine = function (px, py, x1, y1, x2, y2) {
    ...
    b2Separator.prototype.det = function (x1, y1, x2, y2, x3, y3) {
        return x1 * y2 + x2 * y3 + x3 * y1 - y1 * x2 - y2 * x3 - y3 * x1;
    };

    b2Separator.prototype.err = function err() {
        throw new Error("A problem has occurred. Use the Validate() method to see where the problem is.");
    };

    Box2D.Box2DSeparator.b2Separator = b2Separator;
})();